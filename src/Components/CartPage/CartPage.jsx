  ...
  if(cartItems.length===0){
    return <div className='container mx-auto px-4 py-8'>
      <div className='text-center'>
        ...
        <Link to='/' className='inline-block bg-zinc-200 px-6 py-2 rounded-lg hover:bg-zinc-300'>Continue Shoping</Link>
      </div>
    </div>
  }
  return (
    <div className='container mx-auto px-4 py-8'>
      <h2 className='text-2xl font-bold mb-8'>Shoping Cart</h2>
            ...
            <img src={item.image} alt={item.title} className='w-24 h-24 object-contain rounded'/>
             ...
             <div className='flex-1'>
               ...
               <div className='flex items-center gap-2 mt-2'>
                <button className='p-1 rounded-full hover:bg-gray-100'  onClick={()=>dispatch(updateQuantity({id:item.id,quantity:Math.max(0,item.quantity -1)}))}>
                  <Minus size={16}/>
                </button>
